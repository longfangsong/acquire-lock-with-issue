...
(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (autoUnlock || forceUnlockOnly) {
            ...
            const currentHolder = yield currentLockHolder(octokit, issueId);
            if (forceUnlockOnly) {
            ...
            octokit.issues.update(Object.assign(Object.assign({}, github.context.repo), { issue_number: issueId, body: "" }));
